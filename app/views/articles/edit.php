...
<div class="row">
    <div class="col-md-10 mx-auto">
        <div class="card card-body bg-light mt-5">
            <h2>ویرایش مطلب</h2>
            <p>لطفا فرم زیر را برای ویرایش مطلب تکمیل کنید.</p>
            <form action="<?php echo URL_ROOT; ?>/articles/edit/<?php echo $data['id']; ?>" method="post">
                <?php echo csrf_input(); ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea id="summernote" name="content" class="form-control <?php echo (!empty($data['content_err'])) ? 'is-invalid' : ''; ?>"><?php echo htmlspecialchars($data['content']); ?></textarea>
                    <span class="invalid-feedback d-block"><?php echo $data['content_err']; ?></span>
                </div>

                <div class="form-group mb-3">
                    <label for="tags">برچسب‌ها (با کاما جدا کنید):</label>
                    <input type="text" name="tags" class="form-control" value="<?php echo htmlspecialchars($data['tags']); ?>">
                </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="<?php echo URL_ROOT; ?>/articles/show/<?php echo $data['id']; ?>" class="btn btn-secondary">انصراف</a>
                </div>
            </form>
        </div>
    </div>
